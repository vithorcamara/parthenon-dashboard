...
Um módulo utilitário não deve ter dependências de `core`, `app`, `screens` ou `ui`. Ele resolve um problema genérico que poderia, teoricamente, ser copiado e colado em outro projeto sem modificação.
